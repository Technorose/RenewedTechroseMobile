      ...
      >
        <View className="form space-y-2">
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <KeyboardAvoidingView className="gap-y-3">
              <View>
          ...
          <Pressable className="flex items-end">
            <Text style={{ fontSize: hp(1.8) }} className="text-gray-700 mb-5">Forgot Password?</Text>
          </Pressable>
          <Pressable onPress={Login} className="py-3 bg-yellow-400 rounded-xl">
            <Text style={{ fontSize: hp(2.7) }} className="font-bold text-center text-gray-700">Login</Text>
          </Pressable>
        </View>
        <Text style={{ fontSize: hp(1.8) }} className="text-gray-700 font-bold text-center py-5">Or</Text>
        ...
        <View className="flex-row justify-center gap-x-2 mt-7">
          <Text style={{ fontSize: hp(1.8) }} className="text-gray-500 font-semibold">Don't have an account?</Text>
          <Pressable onPress={() => navigation.navigate("Register")}>
            <Text style={{ fontSize: hp(1.8) }} className="font-semibold text-yellow-500">Sign Up</Text>
          </Pressable>
        </View>
      </View>
